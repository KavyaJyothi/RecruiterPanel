...
import logging
import time
class JobPostingFlowAddCompany(SeleniumDriver):
    ...
    xpath_other_company_chkbx="//span[@class='switch switch-small checked']/small"
    ...
    def otherCompanyChkbox(self):
        self.elementClick(self.xpath_other_company_chkbx, locatorType='xpath')
